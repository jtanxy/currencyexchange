...
def _make_request(
    ...
    if crumb is not None:
        params['crumb'] = crumb
    r = getattr(session, method)(url, params=params, json=data, verify=False)
    json = r.json()
    if response_field:
        try:
...
def get_currencies():
    ...
    return _make_request(url, response_field="currencies", country="United States", verify=False)
